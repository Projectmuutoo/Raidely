...
import 'package:raidely/pages/pagesMember/receiverStatus.dart';
...
class _ListproductsreceivedPageState extends State<ListproductsreceivedPage> {
  ...
  Future<void> loadDataAsync() async {
    ...
    var responseDeliveryReceiverId = await http.get(Uri.parse(
        '$url/delivery/receiver/${resultsResponseMemberBody[0].mid}'));
    resultsResponseDeliveryByMid =
        deliveryByMidGetResponseFromJson(responseDeliveryReceiverId.body);
    setState(() {});
  }
